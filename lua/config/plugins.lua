...
return require("lazy").setup({"APZelos/blamer.nvim", "HiPhish/rainbow-delimiters.nvim", "airblade/vim-gitgutter", "github/copilot.vim", "hrsh7th/cmp-nvim-lsp", "hrsh7th/nvim-cmp", "ianks/vim-tsx", "leafgarland/typescript-vim", "neovim/nvim-lspconfig", "nvim-lua/plenary.nvim", "nvim-telescope/telescope-ui-select.nvim", "pangloss/vim-javascript", "tpope/vim-commentary", "tpope/vim-fugitive", "tpope/vim-projectionist", "tpope/vim-surround", "tpope/vim-unimpaired", "williamboman/mason.nvim", {"Olical/nfnl", ft = "fennel", config = _3_}, {"CopilotC-Nvim/CopilotChat.nvim", build = "make tiktoken", config = _4_, dependencies = {{"github/copilot.vim"}, {"nvim-lua/plenary.nvim", branch = "master"}}}, {"ellisonleao/gruvbox.nvim", config = true, priority = 1000}, {"folke/which-key.nvim", event = "VeryLazy", keys = {{"<leader>?", _5_, desc = "Buffer Local Keymaps (which-key)"}}}, {"nvim-neorg/neorg", dependencies = {{"nvim-lua/plenary.nvim"}, {"nvim-neorg/neorg-telescope"}}, opts = {load = {["core.concealer"] = {}, ["core.defaults"] = {}, ["core.dirman"] = {config = {default_workspace = "journal", workspaces = {journal = "~/notes"}}}, ["core.integrations.telescope"] = {config = {insert_file_link = {show_title_preview = true}}}, ["core.integrations.treesitter"] = {}, ["core.journal"] = {config = {workspace = "journal"}}, ["core.qol.todo_items"] = {}, ["core.ui"] = {}}}, version = "*", lazy = false}, {"mfussenegger/nvim-dap", config = _6_, dependencies = {"rcarriga/nvim-dap-ui", "jay-babu/mason-nvim-dap.nvim"}}, {"nvim-treesitter/nvim-treesitter", build = ":TSUpdate"}, {"vhyrro/luarocks.nvim", config = true, priority = 1000}, {"creativenull/efmls-configs-nvim", version = "v1.x.x"}, {"nvim-lualine/lualine.nvim", config = _7_, dependencies = {{"kyazdani42/nvim-web-devicons", opt = true}}}, {"stevearc/oil.nvim", dependencies = {"nvim-tree/nvim-web-devicons"}}, {"windwp/nvim-autopairs", event = "InsertEnter", opts = {}}, {"Olical/conjure", ft = {"fennel"}, lazy = true, dependencies = {{"PaterJason/cmp-conjure"}}, init = _8_}, {"nvim-telescope/telescope.nvim", config = _9_, dependencies = {"nvim-lua/plenary.nvim"}, tag = "0.1.8"}, {"folke/snacks.nvim", opts = {image = {}}}})
