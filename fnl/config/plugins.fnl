...
(if-work? (set chat-model :claude-sonnet-4))
...
((. (require :lazy) :setup) [;; Core Dependencies
                             ...
                             {1 :APZelos/blamer.nvim
                              :event [:BufRead :BufNewFile]}
                             {1 :tpope/vim-fugitive :cmd [:Git :G :Gvdiffsplit :Gread]}
                             ;; LSP and Completion
                             {1 :neovim/nvim-lspconfig :event :BufReadPre}
                             {1 :hrsh7th/nvim-cmp
                              :event :InsertEnter
                              :dependencies [:hrsh7th/cmp-nvim-lsp]}
                             {1 :williamboman/mason.nvim :cmd :Mason}
                             ...
                             {1 :pangloss/vim-javascript :ft :javascript}
                             {1 :Olical/nfnl :ft :fennel :config (fn [])}
                             {1 :Olical/conjure
                              :ft [:fennel]
                             ...
                             {1 :tpope/vim-surround
                              :event [:BufRead :BufNewFile]}
                             {1 :tpope/vim-unimpaired :event :VeryLazy}
                             {1 :tpope/vim-projectionist :event :VeryLazy}
