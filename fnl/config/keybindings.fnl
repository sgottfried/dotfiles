...
(add-keybinding :gd (fn [] (vim.lsp.buf.definition)) "LSP Go to definition")
(add-keybinding :gh (fn [] (vim.lsp.buf.hover)) "LSP Hover")
(add-keybinding :gr (fn [] (vim.lsp.buf.references)) "LSP references")
(add-keybinding :gR (fn [] (vim.lsp.buf.rename)) "LSP rename")
